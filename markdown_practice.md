...
[깃 특강 페이지](https://hphk.notion.site/hphk/Git-1-_A-22-02-09-22-02-11-3f4afeb98f784b7ead4a82f5aebd86de)
...
- 파이프(|), 하이픈(-)으로 만들순 있는데 힘듬
- 본문 표 삽입 ctrl+t

| 날짜               | 강의명  | 강사         |
| ------------------ | ------- | ------------ |
| 02.09~02.11        | git특강 | 배지원강사님 |
|                    |         |              |
| 행늘리기 ctrl 엔터 |         |              |
